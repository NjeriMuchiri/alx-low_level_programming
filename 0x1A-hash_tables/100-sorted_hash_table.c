...
/**
 * shash_table_get - function thatretrieves a value associated with a key
 * @ht: pointer to the shash table
 * @key: key of the shash
...
/**
 * shash_table_print_rev - function that prints the keys and values of
 * the shash table in reverse
 * @ht: pointer to the shash table
 * Return: no return
 */
